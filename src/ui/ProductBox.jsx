...
function ProductBox({ data }) {
  ...
  return (
    <StyledContainer className="overflow-hidden rounded-xl max-w-56 bg-slate-600 text-gray-200 shadow-md hover:scale-[1.03] transition-all">
      ...
      <StyledProductInfo className="flex justify-between items-center flex-col p-1 text-center mx-auto w-[90%] h-[39%]">
        ...
        <div className="w-full flex justify-between items-center">
          <price className="flex items-center h-10">{price}$</price>
