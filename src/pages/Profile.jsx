...
function Profile() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-around items-center bg-slate-400 min-h-[54vh] mt-4 rounded-xl overflow-y-scroll">
      <div className="w-full md:w-1/2 flex items-center md:items-start flex-col gap-1 h-[23rem] overflow-y-scroll py-4 px-4">
        {!isLoading
